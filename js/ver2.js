function genRandom(start, end){
  ...
  $(document).ready(function(){
    $('.err-rprt-cvr').hide();
    $('.prog').hide();
    var quips = ["BIENVENIDO DE NUEVO","HOLA AMIGO ¿COMO ESTAS?","VIENDO EL CALENDARIO EH","¿QUE DIA ES HOY?","¿TENEMOS EVENTO NUEVO?","¿HOY NO ES JUEVES? JURARIA QUE SI..." ,"QUE LINDO DIA ¿NO TE PARECE?", "¿QUE HACES?", "HOLAAA, TIEMPO SIN VERNOS"];
